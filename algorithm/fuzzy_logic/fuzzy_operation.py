...
if __name__ == "__main__":
    ...
    # Buat dua himpunan fuzzy dengan
    # mendefinisikan fungsi keanggotaan apapun
    # (trapmf(), gbellmf()m gaussmf())
    abc1 = [0, 25, 50]
    abc2 = [25, 50, 75]
    young = fuzz.membership.trimf(X, abc1)
    middle_aged = fuzz.membership.trimf(X, abc2)

    # Hitung operasi yang berbeda menggunakan fungsi bawaan.
    one = np.ones(75)
    zero = np.zeros((75,))
    ...
    # Plot tiap set A, set B dan
    # setiap hasil operasi hasil menggunakan
    # plot() dan subplot()
