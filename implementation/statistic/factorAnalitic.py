...
class Factor_Analisis:
    ...
    def fit(self, x: np.array):
        ...
        if X_scaled.shape[0] < X_scaled.shape[1]:
            ...
            _, S, V = randomized_svd(covariance_matrix, n_components=self.n_factors)
            eigenvalues = S**2
            eigenvectors = V.T
        else:
            # Menggunakan eigendecomposition biasa jika jumlah sampel lebih besar
            # atau sama dengan jumlah fitur
